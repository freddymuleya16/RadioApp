    ...
    <div class="nav-bar">
      ...
      <div class="nav-bar-right">
        <ul>
          ...
          <li <?php echo (isLoggedIn()) ? "style='display:none;'" : ""; ?>><a href="<?php echo URLROOT; ?>Account/login" <?php echo ($action == 'login' ? 'class="active"' : ''); ?>>login</a></li>
          <li <?php echo (!isLoggedIn()) ? "style='display:none;'" : ""; ?>><a href="<?php echo URLROOT; ?>Account/logout" <?php echo ($action == 'logout' ? 'class="active"' : ''); ?>>logout</a></li>
          <li <?php echo (!isAdmin()) ? "style='display:none;'" : ""; ?>><a href="<?php echo URLROOT; ?>Account/admin" <?php echo ($action == 'admin' ? 'class="active"' : ''); ?>>Admin</a></li>
          <li <?php echo (isLoggedIn()) ? "style='display:none;'" : ""; ?>><a href="<?php echo URLROOT; ?>Account/register" <?php echo ($action == 'register' ? 'class="active"' : ''); ?>>Register</a></li>
