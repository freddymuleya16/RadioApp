...
<div id="container" >
  ...
  <div id="audio-player">
    <div id="player_tab2">
    <div id="audio-info">
      <div id='numDislikes'></div><img id="unlikeBtn" src="<?php echo URLROOT;?>public\media\img\unlike.png"><span class="ide" style="display: none;"></span><span class="artist"></span> - <span class="title"></span><img id="likeBtn" src="<?php echo URLROOT;?>public\media\img\like.png"><div id='numLikes'></div>
    </div>
