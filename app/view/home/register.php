...
<div class="wrapper">
  <h3>Registration</h3>
  <div id="error_message"><?php //$a=new Cheeese; ?><a href="#" data-toggle="tooltip" title="Some text">Hover over me</a></div>
  <form id="myform" action="<?php  echo URLROOT;?>users/register/" method='post'>
  <div class="form">
